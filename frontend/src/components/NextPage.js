...
const NextPage = ({ searchValue }) => {
  ...
  mappedProducts.forEach((product) => {
    if (product.Zone === "Zone6-2-81" && product.Box === "B-81") {
      arr81.push(product);
    }
  });
  ...
  mappedProducts.forEach((product) => {
    if (product.Zone === "Zone6-3-82" && product.Box === "B-82") {
      arr82.push(product);
    }
  });
  ...
  mappedProducts.forEach((product) => {
    if (product.Zone === "Zone7-1-83" && product.Box === "B-83") {
      arr83.push(product);
    }
  });
  ...
  mappedProducts.forEach((product) => {
    if (product.Zone === "Zone7-2-84" && product.Box === "B-84") {
      arr84.push(product);
    }
  });
  ...
  mappedProducts.forEach((product) => {
    if (product.Zone === "Zone7-3-85" && product.Box === "B-85") {
      arr85.push(product);
    }
  });
      ...
      <div className="bg-[#1E1E1E] w-[100vw] h-[100vh]">
        ...
        >
          ...
          <div
            ...
            } absolute top-[22vh] left-[6vw] w-[18px] h-[18px] bg-[#828282] rounded-md cursor-pointer ${
              arr81.some(
                (product) =>
                  product.MATERIAL_DESC === searchValue ||
                  product.PART_NO === searchValue
          ...
          <div
            ...
            } absolute top-[28.5vh] left-[6vw] w-[18px] h-[18px] bg-[#828282] rounded-md cursor-pointer ${
              arr82.some(
                (product) =>
                  product.MATERIAL_DESC === searchValue ||
                  product.PART_NO === searchValue
